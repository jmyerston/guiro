...
# patterns = ["between|pobj|ENTITY_ONE ENTITY_ONE|conj|ENTITY_TWO"]
# patterns = ["between|pobj|ENTITY_ONE", "ENTITY_ONE|cc|and  ENTITY_ONE|conj|ENTITY_TWO"]
# patterns = ["between|pobj|ENTITY_ONE", "ENTITY_ONE|conj|ENTITY_TWO"]
patterns = ["given|nsubjpass|ENTITY_ONE given|dative|ENTITY_TWO ENTITY_TWO|pobj|ENTITY_FOUR ENTITY_FOUR|prep|of of|pobj|ENTITY_THREE"]

#patterns = ["agreement|compound|ENTITY_ONE", "between|pobj|ENTITY_ONE ENTITY_ONE|cc|and ENTITY_ONE|conj|ENTITY_TWO"]
# patterns = ["set|aux|will set|dobj|terms terms|relcl|ENTITY_ONE ENTITY_ONE|nsubj|ENTITY_TWO ENTITY_ONE|dobj|ENTITY_THREE ENTITY_ONE|prep|to to|pobj|ENTITY_FOUR"]
