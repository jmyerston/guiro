...
st.title("Diogenet Pattern Builder")
...
text = st.text_area("", "Later he sent him to Anaximander at Miletus, to learn geometry and astronomy")
doc = nlp(text) 
...
st.header('Pattern:')
patterns_text = st.text_area("" ,"send|nsubj|ENTITY_TWO send|dobj|ENTITY_THREE send|prep|at at|pobj|ENTITY_ONE")
